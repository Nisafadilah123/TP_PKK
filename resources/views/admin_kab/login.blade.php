...
{{-- @extends('layouts.app') --}}
@extends('admin_kab.layout_login')
@section('content')
{{-- <div class="container">
...
<div class="login-box">
    <div class="login-logo">
      <a href="../../index2.html"><b>Admin</b>Kabupaten</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <p class="login-box-msg">Silahkan Login Admin TP PKK Kabupaten</p>

        <form method="POST" action="{{ route('admin_kabupaten.login') }}">
            @csrf
            <div class="row">
                <div class="col-md-12">
