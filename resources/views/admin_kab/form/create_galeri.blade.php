      ...
      <form action="{{ route('galeriKeg.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama_gambar" id="nama_gambar" placeholder="Masukkan Keterangan Gambar" required>
          </div>
          <div class="form-group">
            <label>Nama Kegiatan</label>
            <input type="text" class="form-control" name="nama_kegiatan" id="nama_kegiatan" placeholder="Masukkan Nama Kegiatan Gambar" required>
          </div>

          <div class="form-group">
            <label>Tanggal Publsih Gambar</label>
            <input type="date" class="form-control" name="tgl_publish" id="tgl_publish" placeholder="Masukkan Tanggal Publish Gambar" required>
          </div>
          <div class="form-group">
            <label>Pengirim Gambar</label>
            <input type="text" class="form-control" name="pengirim" id="pengirim" placeholder="Masukkan Pengirim Gambar" required>
          </div>
          <div class="form-group">
