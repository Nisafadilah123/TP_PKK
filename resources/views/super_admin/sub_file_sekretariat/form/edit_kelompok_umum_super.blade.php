      ...
      <form action="{{ url ('/kelompok_super', $kelompok_super->id) }}" method="POST">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input min="0" type="number" class="form-control" name="jml_pkk_rw" id="jml_pkk_rw" placeholder="Masukkan Jumlah Kelompok PKK RW" required value="{{ucfirst(old('jml_pkk_rw', $kelompok_super->jml_pkk_rw))}}">
          </div>
          <div class="form-group">
            <label>Jumlah Kelompok PKK RT</label>
            <input min="0" type="number" class="form-control" name="jml_pkk_rt" id="jml_pkk_rt" placeholder="Masukkan Jumlah Kelompok PKK RT" required value="{{ucfirst(old('jml_pkk_rt', $kelompok_super->jml_pkk_rt))}}">
          </div>
          <div class="form-group">
            <label>Jumlah Kelompok Dasawisma</label>
            <input min="0" type="number" class="form-control" name="jml_dasawisma" id="jml_dasawisma" placeholder="Masukkan Jumlah Kelompok Dasawisma" required value="{{ucfirst(old('jml_dasawisma', $kelompok_super->jml_dasawisma))}}">
          </div>
          <div class="form-group">
            <label>Periode</label>
            <input min="0" type="number" class="form-control" name="periode" id="periode" placeholder="Masukkan Periode" required value="{{ucfirst(old('periode', $kelompok_super->periode))}}">
          </div>
