...
@section('title', 'Tambah Data Kelompok Simulasi dan Penyuluhan PKK Data Aset | Admin Desa PKK Kab. Indramayu')

@section('bread', 'Tambah Data Kelompok Simulasi dan Penyuluhan PKK Data Aset')
@section('container')
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Tambah Data Kelompok Simulasi dan Penyuluhan PKK Data Aset</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-6">
                        ...
                        {{-- Jumlah anggota --}}
                            <label>Jenis Simulasi/Penyuluhan</label>
                                <input type="number" min="0" class="form-control @error('jenis_simulasi') is-invalid @enderror" name="jenis_simulasi" id="jenis_simulasi" placeholder="Masukkan Jenis Simulasi/Penyuluhan Kelompok">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            {{-- Jumlah Simulasi --}}
                            <label>Jumlah Simulasi</label>
                                <input type="number" min="0" class="form-control @error('jumlah_anggota_perempuan') is-invalid @enderror" name="jumlah_anggota_perempuan" id="jumlah_anggota_perempuan" placeholder="Masukkan Jumlah Sosialisasi yang Telah dilaksanakan">
