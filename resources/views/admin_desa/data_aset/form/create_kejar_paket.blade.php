...
@section('title', 'Tambah Data Kejar Paket PKK Data Aset | Admin Desa PKK Kab. Indramayu')

@section('bread', 'Tambah Data Kejar Paket PKK Data Aset')
@section('container')
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Tambah Data Kejar Paket PKK Data Aset</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
