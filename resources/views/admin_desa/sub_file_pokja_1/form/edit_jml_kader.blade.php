    ...
    <div class="card card-primary">
      ...
      <form action="{{ url ('/jml_kader', $jml_kader->id) }}" method="POST">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label>Periode</label>
            <input type="number" class="form-control" name="periode" id="periode" placeholder="Masukkan Jumlah Kader Pola Asuh" required value="{{ucfirst(old('periode', $jml_kader->periode))}}">
          </div>
