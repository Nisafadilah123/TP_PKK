                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered data" id="add-row">
                                    <div class="row">
                                        <div class="col-md-1">
                                            <a href="{{ url('pemanfaatan/create') }}" type="button" class="btn btn-success">Tambah</a><br><br>
                                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('pemanfaatan.destroy',$c->id) }}" method="POST">

                                            {{-- <a class="btn btn-info btn-sm" href="{{ route('sisw.show',$siswa->id) }}">Show</a> --}}

                                                <a class="btn btn-primary btn-sm" href="{{ url('pemanfaatan/'.$c->id.'/edit') }}">Edit</a>
