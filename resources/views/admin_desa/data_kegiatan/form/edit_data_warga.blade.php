        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" name="dasa_wisma" id="dasa_wisma" placeholder="Di isi sesuai dengan nama dasawisma yang diikuti warga yang bersangkutan" required value="{{ucfirst(old('dasa_wisma', $data_warga->dasa_wisma))}}">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select style="cursor:pointer;" class="form-control" id="periode" name="periode">
                            <option value="0" {{ $data_warga->periode ? 'selected' : '' }}>{{ $data_warga->periode }}</option>
                                <?php
                                $year = date('Y');
                                $min = $year ;
                                    $max = $year + 20;
