        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_kader_khusus_paud_sejenis" id="jml_kader_khusus_paud_sejenis" placeholder="Masukkan Jumlah Kader Khusus Paud Sejenis" required value="{{ucfirst(old('jml_kader_khusus_paud_sejenis', $pendidikan->jml_kader_khusus_paud_sejenis))}}">
                    </div>
                    </div>
                </div>
            <div class="col-md-3">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_kader_khusus_BKB" id="jml_kader_khusus_BKB" placeholder="Masukkan Jumlah Kader Khusus BKB" required value="{{ucfirst(old('jml_warga_buta', $pendidikan->jml_kader_khusus_BKB))}}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="jml_kader_khusus_koperasi" id="jml_kader_khusus_koperasi" placeholder="Masukkan Jumlah Kader Khusus Koperasi" required value="{{ucfirst(old('jml_kader_khusus_koperasi', $pendidikan->jml_kader_khusus_koperasi))}}">
                </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_kader_khusus_keterampilan" id="jml_kader_khusus_keterampilan" placeholder="Masukkan Jumlah Kader Khusus Keterampilan" required value="{{ucfirst(old('jml_kader_khusus_keterampilan', $pendidikan->jml_kader_khusus_keterampilan))}}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_kader_umum_LP3" id="jml_kader_umum_LP3" placeholder="Masukkan Jumlah Kader Umum LP3 PKK" required value="{{ucfirst(old('jml_kader_umum_LP3', $pendidikan->jml_kader_umum_LP3))}}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="jml_kader_umum_TPK" id="jml_kader_umum_TPK" placeholder="Masukkan Jumlah Kader Umum TPK" required value="{{ucfirst(old('jml_kader_umum_TPK', $pendidikan->jml_kader_umum_TPK))}}">
                </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="jml_kader_umum_damas" id="jml_kader_umum_damas" placeholder="Masukkan Jumlah Kader Umum Damas" required value="{{ucfirst(old('jml_kader_umum_damas', $pendidikan->jml_kader_umum_damas))}}">
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Periode</label>
                        <input type="number" class="form-control" name="periode" id="periode" placeholder="Masukkan Periode" required value="{{ucfirst(old('periode', $pendidikan->periode))}}">
                    </div>
                </div>
            </div>
        </div>
