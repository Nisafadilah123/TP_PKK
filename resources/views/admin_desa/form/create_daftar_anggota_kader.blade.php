...
@section('title', 'Tambah Data Anggota TP PKK dan Kader | Admin Desa PKK Kab. Indramayu')

@section('bread', 'Tambah Data Anggota TP PKK dan Kader')
@section('container')
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Tambah Data Anggota TP PKK dan Kader</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->

      <form action="{{ route('data_anggota_kader.store') }}" method="POST">
        @csrf
        @if (count($errors)>0)
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('no_registrasi') is-invalid @enderror" name="no_registrasi" id="no_registrasi" placeholder="Masukkan No. Registrasi TP PKK Anggota TP PKK dan Kader" required value="{{ old('no_registrasi') }}">
                        @error('no_registrasi')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-sm-3">
                    <div class="form-group @error('fungsi_keanggotaan') is-invalid @enderror">
                        ...
                        <input type="text" class="form-control @error('fungsi_keanggotaan') is-invalid @enderror" name="fungsi_keanggotaan" id="fungsi_keanggotaan" placeholder="Masukkan Kedudukan/Fungsi Keanggotaan TP PKK" required value="{{ old('fungsi_keanggotaan') }}">
                ...
                <div class="col-sm-3">
                    <div class="form-group @error('kader_khusus') is-invalid @enderror">
                        ...
                        <input type="text" class="form-control @error('kader_khusus') is-invalid @enderror" name="kader_khusus" id="kader_khusus" placeholder="Masukkan Kedudukan/Fungsi Kader Khusus TP PKK" required value="{{ old('kader_khusus') }}">
                        @error('kader_khusus')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-sm-3">
                    <div class="form-group @error('kader_umum') is-invalid @enderror">
                        ...
                        <input type="text" class="form-control @error('kader_umum') is-invalid @enderror" name="kader_umum" id="kader_umum" placeholder="Masukkan Kedudukan/Fungsi Kader Umum TP PKK" required value="{{ old('kader_umum') }}">
                        @error('kader_umum')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
