            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    <p style="font-family: 'Times New Roman', Times, serif; text-align: justify; text-indent: 0.5in;">
