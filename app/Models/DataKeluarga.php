...
class DataKeluarga extends Model
{
    ...
    protected $fillable = [
       'id_desa','id_kecamatan', 'id_warga', 'dasa_wisma', 'kota', 'provinsi', 'rt', 'rw', 'jumlah_anggota_keluarga', 'laki_laki', 'perempuan', 'jumlah_KK', 'jumlah_balita', 'jumlah_PUS', 'jumlah_WUS', 'jumlah_3_buta', 'jumlah_ibu_hamil', 'jumlah_ibu_menyusui',
