    ...
    public function array(): array
    {
        ...
        foreach ($catatan_keluarga as $keluarga) {
            $data = [
                ...
                'laki_laki' => $keluarga->laki_laki ?: '0',
                'perempuan' => $keluarga->perempuan ?: '0',
        ...
        $result[] = [
            ...
            'laki_laki' => $catatan_keluarga->sum('laki_laki') ?: '0',
            'perempuan' => $catatan_keluarga->sum('perempuan') ?: '0',
            ...
            'jumlah_kebutuhan' => $catatan_keluarga->sum('jumlah_kebutuhan') ?: '0',
