...
class dataKecamtanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super_admin.data_kecamatan', compact('kecamatan'));
    ...
    {
        //halaman tambah data
        return view('super_admin.form.create_kecamatan');
    ...
    {
        //halaman edit data
        return view('super_admin.form.edit_kecamatan', compact('data_kecamatan'));
    ...
    public function update(Request $request, DataKecamatan $data_kecamatan)
    {
        ...
        return redirect('/data_kecamatan');
        // return view('super_admin.data_kecamatan', compact('data_kecamatan'));
